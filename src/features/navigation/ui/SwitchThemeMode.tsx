  ...
  '& .MuiSwitch-switchBase': {
    ...
    '&.Mui-checked': {
      ...
      '& .MuiSwitch-thumb:before': {
        backgroundImage: `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" height="${SWITCH_ICON_SIZE}" width="${SWITCH_ICON_SIZE}" viewBox="0 0 20 20"><path fill="${encodeURIComponent(
          '#fff',
...
export const SwitchThemeMode = () => {
  ...
  const { mode, toggleTheme } = themeMode;
